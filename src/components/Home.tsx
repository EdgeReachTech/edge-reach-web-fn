    ...
    >
      ...
      <div className="relative flex flex-col items-center justify-center h-full px-4 md:px-9 text-center text-white">
        ...
        <div className="flex flex-col lg:justify-center items-center mt-8 animate-fadeIn delay-1s">
          <p className="w-full text-base md:text-lg lg:text-xl my-4  lg:w-1/2 font-open">
          ...
          <div className="flex flex-col items-center">
            <h4 className="text-lg md:text-2xl lg:text-4xl font-bold mt-9 font-loboto">
              Our Mission
            </h4>
            <p className="w-full text-base md:text-lg lg:text-xl my-2 lg:w-1/2 font-open">

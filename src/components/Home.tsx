    ...
    >
      ...
      <div className="relative flex flex-col items-center justify-center h-full px-4 md:px-9 text-center text-white">
        <div className="mt-11 flex flex-row justify-center animate-fadeIn space-y-2 md:space-y-0 md:space-x-2">
          <h5 className="px-3 text-lg md:text-3xl lg:text-5xl rounded-l-md font-extrabold bg-white text-black shadow-md">
            BEST
          </h5>
          <h5 className="px-1 text-lg md:text-3xl lg:text-5xl font-extrabold text-white shadow-md">
            IT COMPANY
          </h5>
        </div>
        <div className="flex flex-col lg:justify-center items-center mt-8 animate-fadeIn delay-1s">
          <p className="w-full text-base md:text-xl lg:text-3xl my-4 font-mono lg:w-1/2">
            <b>EdgeReach Tech</b> is connecting top-tier developers to deliver
            custom software for your business needs.
          </p>
          <div className="w-1/5 border-b-8 border-white mt-4 mb-6"></div>
          <div className="flex flex-col items-center">
            <h4 className="text-lg md:text-2xl lg:text-5xl font-bold mt-9">
              Our Mission
            </h4>
            <p className="w-full text-base md:text-lg lg:text-2xl my-2 lg:w-1/2">

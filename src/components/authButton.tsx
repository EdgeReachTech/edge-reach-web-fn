...
const AuthButton: React.FC = () => {
  return (
    <div className={`flex flex-row justify  text-white font-bold `}>
      ...
      <a href="/signup" className="bg-gradient-to-bl from-orange-500 w-32 to-yellow-200 hover:to-yellow-500 p-2 rounded-3xl transition hover:ease-in duration-100 ">
        SIGN UP
      </a>
    </div>
  );

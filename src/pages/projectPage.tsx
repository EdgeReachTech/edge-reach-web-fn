    ...
    <div className="bg-[#C0C0C0]">
      ...
      <div className="my-10 w-fit mx-auto">
        <h3 className="text-white text-xl">
          <span className="bg-[#FFA500] text-black font-bold">PORT </span>FOLIO
          1
        </h3>
        ...
        <div className="space-y-5">
          ...
          <div className="text-center">
            ...
            <p>
              ...
              Canada. This project reflects our ability to create user-friendly,
          ...
          <div className="text-center">
            ...
            <p>
              ...
              website that accurately represented their brand and services to a
              global audience. The goal was to enhance their online presence,
              improve user engagement, and ensure seamless functionality across
              all devices.
            </p>
          </div>
          <div className="text-center">
            ...
            <p>
              Our team delivered a fully customized website featuring: A clean,
              modern design that aligns with CyberPro Group’s branding. Mobile
              responsiveness to ensure accessibility on all devices. Optimized
              performance for fast loading and smooth navigation. A secure
              hosting solution with ongoing maintenance to guarantee reliability
              and uptime.
            </p>
          </div>
          <div className="text-center">
            ...
            <p>
              The new website has significantly improved CyberPro Group’s online
              visibility and credibility. Positive feedback from their team and
              clients highlights the success of this collaboration. The site
              remains a robust tool for engaging customers and showcasing their
              services globally.
            </p>
          </div>
